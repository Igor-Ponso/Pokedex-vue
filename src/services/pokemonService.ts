...
import { MainClient, NamedAPIResource, Pokemon, PokemonFormSprites } from 'pokenode-ts';
...
export const getMinimalPokemonDetails = async (urls: NamedAPIResource[]): Promise<{ id: number, name: string, image: string, types: string[], sprites: PokemonFormSprites }[]> => {
  try {
